...
<body class="signal-theme">{root_header()}<main class="insights-page section-pad"><section class="insights-hero"><div><p class="signal-kicker">Studio Notes</p><h1>Notes behind the work.</h1></div><p>Short notes on design, workflows, and useful digital tools.</p></section><section class="insights-list" aria-label="Published articles">{''.join(cards)}</section></main>{THEME_DOCK}<footer class="footer"><p>© <span id="year"></span> Jann Nathaniel Jaravata / DesignLab Creative Studio</p><p class="footer-meta">Version <span id="siteVersion"></span> · Static SEO-ready articles</p></footer><script src="theme.js?v={VERSION}"></script><script src="navigation.js?v={VERSION}"></script><script src="insights.js?v={VERSION}"></script></body></html>'''
